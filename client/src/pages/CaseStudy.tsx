...
function CaseStudyPage({ study }: { study: CaseStudy }) {
  ...
  return <main className={`case-page case-${study.serial}`}>
    <aside className="case-rail" aria-label="Mitra Kulal case file navigation"><Link className="case-stamp" href="/"><img src="/manus-storage/shocking-mark_c8e9ac58.png" alt="Mitra Kulal personal mark" /></Link><span>MITRA KULAL / CASE FILE</span><div className="case-rail-index">{study.serial} / 03</div><div className="case-rail-status"><i /> INSPECTABLE SYSTEM</div></aside>
