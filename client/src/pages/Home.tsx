  ...
  return (
    <main className="portfolio-shell">
      ...
      <div className="portfolio-content" id="top">
        ...
        <section className="signal-section"><div className="section-label">00 / System readout</div><div className="signal-grid"><div><strong>8.75</strong><span>CGPA / AIML</span></div><div><strong>04</strong><span>System patterns</span></div><div><strong>03</strong><span>Inspectable case files</span></div><div className="signal-note"><Sparkles size={17} /><p>Currently exploring MLOps, scalable vector databases, and system design for AI applications.</p></div></div></section>

        <section className="statement-section" id="about"><div className="section-label">03 / Point of view</div><div className="statement-copy"><p className="large-statement">Useful AI is <mark>grounded.</mark><br /><span>Curious systems<br />know when to ask.</span></p><div className="statement-detail"><span className="detail-rule" /><p>I build with a bias toward inspectable decisions: retrieved context, explicit fallbacks, configurable runtimes, and interfaces that make the system’s behavior legible.</p></div></div></section>
